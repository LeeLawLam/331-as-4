...
def main():
    ...
    # message2 = 'Pm ol ohk hufaopun jvumpkluaphs av zhf, ol dyval pa pu jpwoly, aoha pz, if zv johunpun aol vykly vm aol slaalyz vm aol hswohila, aoha uva h dvyk jvbsk il thkl vba.'
    # letterMapping2 = hackSimpleSub(message2)
    # print(message2)
    # print(letterMapping2)
    # hackedMessage2 = decryptWithCipherletterMapping(message2, letterMapping2)
    # print(hackedMessage2)
